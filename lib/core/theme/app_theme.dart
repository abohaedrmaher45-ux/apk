...
class AppColors {
  // Primary — Sentry Food palette (was orange #FF6900 / #F54900).
  // Changing only these two values recolors every UI element that
  // references AppColors.primary500 / primary600 across the whole app,
  // without touching any widget, function, or logic.
  static const Color primary500 = Color(0xFF885CF6); // Sentry violet
  static const Color primary600 = Color(
    0xFF6D44D9,
  ); // deeper violet (pressed/secondary)
