...
final String _baseUrl = ApiConfig.origin;
...
class ShopLocale extends Equatable {
  ...
  factory ShopLocale.fromJson(Map<String, dynamic> json) {
    ...
    if (code.toLowerCase() == 'de' || name.toLowerCase() == 'deutsch') {
      name = 'Germany';
    }
  ...
  factory WishlistItem.fromJson(Map<String, dynamic> json) {
    ...
    if (priceHtmlData != null && priceHtmlData is Map<String, dynamic>) {
      ...
      final regular = priceHtmlData['regular'] ??
          priceHtmlData['regularPrice'] ??
          priceHtmlData['formattedRegularPrice'];
      final special = priceHtmlData['special'] ??
          priceHtmlData['finalPrice'] ??
          priceHtmlData['formattedFinalPrice'];
      if (regular != null) {
...
class CustomerOrder {
  ...
  String get formattedTotal {
    final code = orderCurrencyCode ?? baseCurrencyCode ?? 'EUR';
