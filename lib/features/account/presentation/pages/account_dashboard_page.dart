...
class _AccountDashboardPageState extends State<AccountDashboardPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          // خلفية الأشكال البنفسجية/الزرقاء (تخطيط مميّز خاص بشاشة الحساب)
          const Positioned.fill(child: SentryBackground(variant: 5)),
          BlocBuilder<AccountDashboardBloc, AccountDashboardState>(
                              ...
                              builder: (_) => RepositoryProvider.value(
                                ...
                                child: MultiBlocProvider(
                                  providers: [
                                    ...
                                    BlocProvider.value(
                                      value: context
                                          .read<AccountDashboardBloc>(),
                                    ),
                                  ],
                                  child: AccountMenuPage(
                                    profile: state.profile,
                                  ),
                                ),
                              ),
