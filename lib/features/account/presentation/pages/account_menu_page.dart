...
import '../pages/api_settings_sheet.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<AuthBloc, AuthState>(
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: [
            // خلفية الأشكال البنفسجية/الزرقاء (تخطيط مميّز خاص بإعدادات الحساب)
            const Positioned.fill(child: SentryBackground(variant: 7)),
            SafeArea(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 2),
          AccountMenuItem(
            label: l10n.accountContactUs,
            trailingIcon: Icons.chevron_right,
            onTap: () => _onMenuItemTap(context, AccountMenuAction.contactUs),
          ),
          const SizedBox(height: 2),
          AccountMenuItem(
            label: 'إعدادات الـ API (اختبار)',
            trailingIcon: Icons.chevron_right,
            onTap: () => _onMenuItemTap(context, AccountMenuAction.apiSettings),
          ),
          const SizedBox(height: 2),
          AccountMenuItem(
  ...
  void _onMenuItemTap(BuildContext context, AccountMenuAction action) {
    switch (action) {
      ...
      case AccountMenuAction.preferences:
        ...
        break;
      case AccountMenuAction.contactUs:
        ContactUsPage.show(context);
        break;
      case AccountMenuAction.apiSettings:
        ApiSettingsSheet.show(context);
        break;
    }
  }
