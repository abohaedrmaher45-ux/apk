        ...
        children: [
          ...
          BlocConsumer<OrdersBloc, OrdersState>(
            ...
            builder: (context, state) {
              // PREVIEW-ONLY: show mock orders when no real data is available.
              if (kUsePreviewData && state.orders.isEmpty) {
                return _OrderList(
                  orders: PreviewData.orders(),
                  totalCount: PreviewData.orders().length,
                  hasNextPage: false,
                  isLoadingMore: false,
                );
              }
...
class _OrderCard extends StatelessWidget {
  ...
  Widget _buildStatusDateRow(BuildContext context, bool isDark) {
    final l10n = AppLocalizations.of(context)!;
    final displayStatus = OrderStatusMapper.resolve(order.status);
        ...
        Container(
          ...
          child: Text(
            ...
            style: TextStyle(
              ...
              fontSize: 12,
              color: isDark ? chipColors.textDark : chipColors.text,
            ),
          ),
        ),
  ...
  /// `text` is used in light mode; `textDark` is a lighter variant so the
  /// label stays readable on the darkened chip in dark mode.
  static _StatusChipColors _getStatusColors(OrderDisplayStatus status) {
    switch (status) {
      case OrderDisplayStatus.newOrder: // جديد — light blue-violet
        return const _StatusChipColors(
          bg: Color(0xFFE9F0FF),
          border: Color(0xFFC9DBFF),
          text: Color(0xFF3B6FE0),
          textDark: Color(0xFF9DBBFF),
        );
      case OrderDisplayStatus.preparing: // قيد التجهيز — lilac
        return const _StatusChipColors(
          bg: Color(0xFFF1EAFE),
          border: Color(0xFFD6B4FE),
          text: Color(0xFF7C4DD6),
          textDark: Color(0xFFCBB0F5),
        );
      case OrderDisplayStatus.ready: // جاهز — amber
        return const _StatusChipColors(
          bg: Color(0xFFFFF3E0),
          border: Color(0xFFFFD9A0),
          text: Color(0xFFC77700),
          textDark: Color(0xFFF5C877),
        );
      case OrderDisplayStatus.outForDelivery: // قيد التوصيل — sky blue
        return const _StatusChipColors(
          bg: Color(0xFFE7F3FF),
          border: Color(0xFFB6DBF8),
          text: Color(0xFF1F76C4),
          textDark: Color(0xFF9CCBF0),
        );
      case OrderDisplayStatus.delivered: // تم التسليم — green
        return const _StatusChipColors(
          bg: Color(0xFFE6F6EC),
          border: Color(0xFFBDE5CB),
          text: Color(0xFF2E9E5B),
          textDark: Color(0xFF9EDBB5),
        );
      case OrderDisplayStatus.canceled: // ملغي — muted rose-violet
        return const _StatusChipColors(
          bg: Color(0xFFF7E9F2),
          border: Color(0xFFE6C2D8),
          text: Color(0xFFB13E7E),
          textDark: Color(0xFFE6A6C7),
        );
    }
  }
}
