...
class _PreferencesBottomSheetState extends State<PreferencesBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = SentryPalette.pageBackground(isDark);
              ...
              child: BlocBuilder<PreferencesCubit, PreferencesState>(
                builder: (context, state) {
                  return Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      // ── عنصر ثابت: إعدادات الـ API (تغيير عنوان السيرفر) ──
                      Padding(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.of(context).pop();
                              ApiSettingsSheet.show(widget.parentContext);
                            },
                            child: Row(
                              children: [
                                Icon(
                      ...
                      Builder(
                        builder: (context) {
                          ...
                          return Column(
                            mainAxisSize: MainAxisSize.min,
                            children: List.generate(state.cmsPages.length, (
                              index,
                            ) {
