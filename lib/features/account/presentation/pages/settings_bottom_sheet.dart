...
class SettingsBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      // قصّ الأشكال ضمن الحواف الدائرية للنافذة المنبثقة
      child: ClipRRect(
        borderRadius: const BorderRadius.only(
          topLeft: Radius.circular(16),
          topRight: Radius.circular(16),
        ...
        child: Stack(
          children: [
            // خلفية الأشكال البنفسجية/الزرقاء (تخطيط مميّز خاص بالإعدادات)
            const Positioned.fill(child: SentryBackground(variant: 6)),
            SafeArea(
              top: false,
              child: Padding(
