        ...
        children: [
          ...
          BlocConsumer<WishlistBloc, WishlistState>(
            ...
            builder: (context, state) {
              ...
              // PREVIEW-ONLY: show mock wishlist when no backend data.
              if (kUsePreviewData && state.items.isEmpty) {
                return _buildWishlistContent(
                  context,
                  state.copyWith(
                    status: WishlistStatus.loaded,
                    items: PreviewData.wishlistItems(),
                  ),
                );
              }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      // Add to Cart button — Flexible so it shrinks to fit
