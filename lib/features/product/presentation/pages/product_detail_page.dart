                ...
                Expanded(
                  child: BlocBuilder<ProductDetailBloc, ProductDetailState>(
                    builder: (context, blocState) {
                      // PREVIEW-ONLY: when the backend isn't connected and no real
                      // product is available, substitute a mock loaded state so the
                      // full detail layout renders. Real data always takes priority.
                      final state =
                          (kUsePreviewData && blocState.product == null)
                          ? ProductDetailState(
                              status: ProductDetailStatus.loaded,
                              product: PreviewData.productDetail(),
                              relatedProducts: PreviewData.relatedProducts(),
                            )
                          : blocState;
