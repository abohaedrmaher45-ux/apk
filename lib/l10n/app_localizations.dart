...
abstract class AppLocalizations {
  ...
  /// No description provided for @homeNewProducts.
  ///
  /// In en, this message translates to:
  /// **'New Products'**
  String get homeNewProducts;
  ...
  /// No description provided for @homeSuggestedProducts.
  ///
  /// In en, this message translates to:
  /// **'Suggested Products'**
  String get homeSuggestedProducts;
